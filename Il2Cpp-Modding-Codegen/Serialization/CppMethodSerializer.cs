...
namespace Il2Cpp_Modding_Codegen.Serialization
{
    public class CppMethodSerializer : ISerializer<IMethod>
    {
        ...
        private string WriteMethod(bool staticFunc, IMethod method, bool namespaceQualified)
        {
            ...
            // Make method static or non-static as a member within the type itself
        ...
        public void Serialize(Stream stream, IMethod method)
        {
            ...
            if (_asHeader)
            {
                ...
                // Create generic method here, open it, and actually write it.
                // Needs to use the generic type parameters
            ...
            else
            {
                ...
                writer.WriteLine(_prefix + WriteMethod(isStatic, method, true));
